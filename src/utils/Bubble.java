...
public class Bubble extends Group{
    ...
    public Bubble(ImageView imageView){
        super();
        initImage(0, 0, imageView, sdf.format(d));
    }
    ...
    private void initImage(int x, int y, ImageView imageView, String meta){
        ImageView image = imageView;
        int imageW = 100;
        int imageH = 100;
        int w = imageW + p * 2 + s * 2;
        int h = imageH + p * 2;

        image.setTranslateX(x + p + s);
        image.setTranslateY(y + p);
